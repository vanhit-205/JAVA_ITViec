...
public interface ResumeApiService {
    ...
    @GET("resumes/{id}/matching-jobs")
    Call<ApiResponse<java.util.List<com.example.timviecapp.models.job.JobResponse>>> getMatchingJobs(
            @Path("id") int id
    );

    @GET("resumes/job/{jobId}/matching-candidates")
    Call<ApiResponse<java.util.List<ResumeResponse>>> getMatchingCandidates(
